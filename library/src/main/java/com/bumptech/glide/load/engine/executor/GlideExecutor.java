...
// 这里构造 glide 的线程池
    ...
    /**
     * The default thread name prefix for executors used to load/decode/transform data found in// 下载 解码 转码
     * Glide's cache.
     */
    ...
    // Don't use more than four threads when automatically determining thread count..// 自动决定线程数 不能超过4
     ...
     * http://goo.gl/8H670N.
     */
    public static int calculateBestThreadCount() { // 计算最好的线程数量
     ...
     */
    private static final class DefaultThreadFactory implements ThreadFactory { // 默认 线程工厂
